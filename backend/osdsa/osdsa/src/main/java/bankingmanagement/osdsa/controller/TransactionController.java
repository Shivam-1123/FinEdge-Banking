   ...
   @GetMapping("/{customerId}/transactions")
    public List<Transaction> getCustomerTransactions(@PathVariable String customerId) {
        ...
        return allTransactions.stream()
                .filter(txn -> (txn.getSenderCustomerId().equals(customerId) && "Debit".equals(txn.getTransactionType())) || 
                               (txn.getRecipientCustomerId().equals(customerId) && "Credit".equals(txn.getTransactionType())))
